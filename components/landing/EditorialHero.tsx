          ...
          >
            ...
            >
              <Image
                ...
                sizes="(max-width: 768px) 280px, (max-width: 1200px) 440px, 540px"
              />
            </div>

            <div style={{ transform: "translateZ(20px)" }} className="mt-3 sm:mt-5 space-y-2">
            ...
            <div style={{ transform: "translateZ(25px)" }} className="mt-4 flex items-center justify-center">
              <Link
                href="/events"
                ...
                aria-label="Browse all festival tournaments"
              >
